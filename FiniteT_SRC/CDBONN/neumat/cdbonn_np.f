...
c
c
      common /crdwrtNP/ kread,kwrite,kpunch,kda(9)
c
...
c
      common /cobqNP/vj(32,50),c(20,50),fff,ff,f(52),aa(96),ai(19,15),
...
c       write(kwrite,*)iq,kread,index,indpar(inter)
...
c       inversion                                                     
c                                                                       
      call dminvNP (adminv,4,deter,ldminv,mdminv)                         
c                                                                       
c
c
...
!      open(unit=11,file='input_np.dat') 
!      rewind(11)
...
c
 9999 stop
      ...
      subroutine obstrqNP (icase,max,mex)
c
...
c
      if (j.eq.0) then
c
      call legen2NP (qj,qjp1,zzq1m,1,zstamm,zdelta)
      qjm1=0.d0
c
      else
c
      call legen2NP (qjm1,qj,zzq1m,j,zstamm,zdelta)
c
      end if
c
c
...
c
      ...
      subroutine legen2NP (qjm1,qj,zzq1m,j,zstamm,zdelta)
c
