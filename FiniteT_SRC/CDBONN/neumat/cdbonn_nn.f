...
c
      common /cobqNN/vj(32,50),c(20,50),fff,ff,f(52),aa(96),ai(19,15),
...
c       inversion                                                     
c                                                                       
      call dminvNN (adminv,4,deter,ldminv,mdminv)                         
c                                                                       
c
c
...
!      open(unit=11,file='input_nn.dat') 
...
c
 9999 stop
      ...
      subroutine obstrqNN (icase,max,mex)
c
...
c
      if (j.eq.0) then
c
      call legen2NN (qj,qjp1,zzq1m,1,zstamm,zdelta)
      qjm1=0.d0
c
      else
c
      call legen2NN (qjm1,qj,zzq1m,j,zstamm,zdelta)
c
      end if
c
c
...
c
      ...
      subroutine legen2NN (qjm1,qj,zzq1m,j,zstamm,zdelta)
c
